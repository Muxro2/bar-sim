...
export default function Bottle({ caption }: {caption: string}) {
	...
	return (
		<div className="relative w-full h-full flex flex-col">
		  ...
		  <div className="relative w-full h-full rounded-[30px_30px_0%_0%] flex justify-end items-start overflow-hidden"
			style={{ backgroundColor: color }}>
      ...
      <h1 className="absolute top-[10px] right-[50%] -rotate-90 origin-right text-md text-right font-roboto leading-[1em] text-black/30 z-10">{caption}</h1>
				</div>
